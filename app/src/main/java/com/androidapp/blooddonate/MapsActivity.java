...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback, LocationListener , DialogInterface{
    ...
    public MapsActivity ( String provider ) {
    ...
    public MapsActivity ( int contentLayoutId, int locNumber ) {
    ...
    public void onMapReady(@NonNull GoogleMap googleMap) {
        ...
        /*LatLng currentLoc = new LatLng(parseDouble(location.get_Latitude())
                , parseDouble(location.get_Longitude()));*/
     /*   mMap.moveCamera(CameraUpdateFactory.newLatLng(currentLoc));
        marker.setPosition(currentLoc);*/


        LatLng currentLoc = new LatLng(parseDouble(location.get_Latitude()),parseDouble( location.get_Longitude()));
        mMap.moveCamera(CameraUpdateFactory.newLatLng(currentLoc));

        mMap.animateCamera(CameraUpdateFactory.newLatLngZoom(new LatLng(parseDouble(location.get_Latitude()), parseDouble(location.get_Longitude())), 17.0f));
        ...
        MarkerOptions userIndicator = new MarkerOptions()
                .position(new LatLng(parseDouble(location.get_Latitude()), parseDouble(location.get_Longitude())))
                .title("You are here")
                .snippet("lat:" + parseDouble(location.get_Latitude()) + ", lng:" +  parseDouble(location.get_Longitude()));
        ...
        try {
            get_full(parseDouble(location.get_Latitude()), parseDouble(location.get_Longitude()));
    ...
    public void locateLocs() {
        ...
        for (int i = 0; i < locNumber; i++) {
            LatLng thisLoc = new LatLng(parseDouble(locsToMap.get(i).get_Latitude()), parseDouble(locsToMap.get(i).get_Longitude()));
        ...
        locationsRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                for (DataSnapshot snap : snapshot.getChildren()) {
                    ...
                    assert loc != null;
                    LatLng newLoc = new LatLng(parseDouble(loc.get_Latitude()), parseDouble(loc.get_Longitude()));
    ...
    public void markerToast(){
        ...
        mMap.setOnMarkerClickListener(new OnMarkerClickListener() {
            ...
            public boolean onMarkerClick(@NonNull Marker marker) {
                double distance = distance(parseDouble(location.get_Latitude()), parseDouble(location.get_Longitude()),marker.getPosition().latitude,marker.getPosition().longitude);
    ...
    public void deleteLoc(Marker maker){
        ...
        LatLng latLng = new LatLng(parseDouble(locToDelete.get_Latitude()), parseDouble(locToDelete.get_Longitude()));
    ...
    public void onLocationChanged(@NonNull android.location.Location location) {
      ...
      Location location_xy = new Location(lat, lng);
